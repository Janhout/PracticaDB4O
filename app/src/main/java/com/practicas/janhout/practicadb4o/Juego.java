...
public class Juego implements Comparable<Juego>, Parcelable {
    ...
    public void copiar(Juego j){
        this.nombre = j.getNombre();
        this.publicacion = j.getPublicacion();
        this.informacion = j.getInformacion();
        this.tipo = j.getTipo();
        this.foto = j.getFoto();
        this.dificultad = j.getDificultad();
        this.puntuacion = j.getPuntuacion();
        this.expansion = j.isExpansion();
    }
}
